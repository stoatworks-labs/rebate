/*
 * Stoatworks Labs - About window data for rebate.
 *
 * PROVISIONAL HAND COPY, in the shape stoatworks-backend/scripts/sync-about.py
 * generates (adapted from pitch's hand copy on 2026-09-23). The
...
namespace stoatworks::about
{
    ...
    inline constexpr auto hook = "Colour negative film, and the scan of it, for Resolume";
